...
socket.on('mensajes', (data) => {
    const desnormalizarMensajes = desnormalize(data.result,mensajes,data.entities);
    console.log(desnormalizarMensajes);
    console.log(data);
    render(data);
});
...
const envioMensaje = (f) => {
    ...
    socket.emit('nuevo',{mail,nombre,apellido,edad,alias,avatar,mensaje});
};
